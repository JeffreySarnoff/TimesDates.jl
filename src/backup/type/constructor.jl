Time(zdt::ZonedDateTime) = Time(DateTime(zdt))
Date(zdt::ZonedDateTime) = Date(DateTime(zdt))
Time(tdz::TimeDateZone) = Time(TimeDate(tdz))
Date(tdz::TimeDateZone) = Date(TimeDate(tdz))
